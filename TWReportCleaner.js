...
window.STORAGE_KEY ??= 'twReportCleanerPrefs';
window.defaultCategories ??= ['trade','event','other'];
window.AllCategories ??= ['attack','defense','support','trade','event','other'];
window.REQUIRED_SCREEN ??= 'report';
